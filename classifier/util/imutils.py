...
def random_crop_with_saliency(imgarr, mask, crop_size):
    ...
    container_mask[cont_top : cont_top + ch, cont_left : cont_left + cw] = mask[
        img_top : img_top + ch, img_left : img_left + cw
    ]
...
class Normalize:
    ...
    def __call__(self, img):
        ...
        normalized_img[..., 0] = (img_arr[..., 0] / 255.0 - self.mean[0]) / self.std[0]
        normalized_img[..., 1] = (img_arr[..., 1] / 255.0 - self.mean[1]) / self.std[1]
        normalized_img[..., 2] = (img_arr[..., 2] / 255.0 - self.mean[2]) / self.std[2]
